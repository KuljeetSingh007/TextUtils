...
export default function Nav(prop) {
    ...
    return (
        <nav className={`navbar navbar-expand-lg bg-${prop.mode}  navbar-${prop.mode} ${prop.theme}`}>
        {/* <nav className={`navbar navbar-expand-lg    ${prop.theme}`}> */}
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div onClick={prop.redTheme} className={`${close ? "colorRed redOpen" : "colorRed"}`}></div>
                    <div onClick={prop.blueTheme} className={`${close ? "colorBlue blueOpen" : "colorBlue"}`}></div>
                    <div onClick={prop.goldTheme} className={`${close ? "colorGold goldOpen" : "colorGold"}`}></div>
                    <div onClick={prop.whiteTheme} className={`${close ? "colorWhite whiteOpen" : "colorWhite"}`}></div>
                    <div className={` ${close ? "themeOpt open" : "themeOpt "} ${prop.mode === 'light' ? 'light' : 'dark'}`}></div>
                    ...
                    <div className={`form-check form-switch text-${prop.mode === 'light' ? 'dark' : 'light'}`}>
                        ...
                        <label className="form-check-label" for="flexSwitchCheckDefault">{prop.mode === 'light' ? 'light' : 'Dark'}</label>
                    </div>
                </div>
            </div>
        </nav>
